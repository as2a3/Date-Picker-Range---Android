...
/**
 * Created by Ahmed Said on 19,05,2018
 */
public class DateRangeCalendarView extends LinearLayout {

//    private static final Logger LOG = LoggerFactory.getLogger(DateRangeCalendarView.class);
    ...
    private Boolean isRangePicker = true;
...
//            LOG.info("Time: " + selectedCal.getTime().toString());
            ...
            } else if (calendarListener != null && minSelectedDate != null) {
                calendarListener.onDateSelected(minSelectedDate);
            }
        }
    };
...
//        LOG.info("Current cal: " + month.getTime().toString());
...
//                LOG.info("Date: " + month.getTime().toString());
